...
public class FreelaController : MyFreelasController
{
        ...
        RequestRegisterFreelaJson request)
    {
        ...
        try
        {
            var response = await _service.RegisterFreelaAsync(request);
        ...
        [FromBody] RequestGetFreelaJson request)
    {
        try
        {
            var response = await _service.GetAllAsync(request, paginationParameters);
            if (response.Any())
            {
                return Ok(response);
            }
    ...
    public async Task<ActionResult> UpdateAsync(
        string fHashId, RequestUpdateFreelaJson request)
    {
        ...
        try
        {
            await _service.UpdateAsync(fHashId, request);
            return NoContent();
        }
        catch (InvalidIDException e)
        {
        ...
        [FromRoute] string fHashId)
    {
        try
        {
            var response = await _service.GetByIdAsync(fHashId);
            return Ok(response);
        }
        catch (InvalidIDException e)
        {
    ...
    public async Task<ActionResult> DeleteAsync(string fHashId)
    {
        try
        {
            await _service.DeleteAsync(fHashId);
            return NoContent();
        }
        catch (ProjectNotFoundException e)
        {
